...
<body>
  <div class="container mt-5">
    <h2 class="text-center">Welcome, <?php echo $_SESSION['firstName']; ?>!</h2>
    <p class="text-center">You have successfully logged in with Voter ID: <?php echo $_SESSION['voterId']; ?></p>
